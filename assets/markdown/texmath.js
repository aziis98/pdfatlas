...
if (typeof module === "object" && module.exports)
   ...
   // Loaded as a classic <script> in the note preview webview: expose a global
   // (upstream relies on top-level function declarations becoming window props;
   // make it explicit so the binding survives regardless of script context).
